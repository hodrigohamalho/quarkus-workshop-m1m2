= RAMALHO Reactive Streams with Quarkus and Kafka 
:experimental:
:imagesdir: images
...
== What is Apache Kafka? RAMALO

RAMALHO Apache Kafka is a distributed streaming platform. A streaming platform has three key capabilities:
